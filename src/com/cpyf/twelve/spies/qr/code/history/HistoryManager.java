...
package com.cpyf.twelve.spies.qr.code.history;
...
public final class HistoryManager
{
    ...
    private static final String[] GET_ITEM_COL_PROJECTION = {
                    DBHelper.TEXT_COL, DBHelper.DISPLAY_COL,
                    DBHelper.FORMAT_COL, DBHelper.TIMESTAMP_COL, };
    ...
    public AlertDialog buildAlert()
    {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                Result result = new Result(cursor.getString(0), null, null,
                                BarcodeFormat.valueOf(cursor.getString(2)),
                                cursor.getLong(3));
                items.add(result);
        ...
        builder.setItems(dialogItems.toArray(new String[dialogItems.size()]),
            clickListener);
    ...
    CharSequence buildHistory()
    {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                historyText.append('"')
                                .append(
                                    massageHistoryField(EXPORT_DATE_TIME_FORMAT
