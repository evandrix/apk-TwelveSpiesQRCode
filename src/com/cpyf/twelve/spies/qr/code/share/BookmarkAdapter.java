...
package com.cpyf.twelve.spies.qr.code.share;
 ...
 * we used
 * SimpleCursorAdapter, but it assumes the existence of an _id column, and the
 * bookmark schema was
 * rewritten for HC without one. This caused the app to crash, hence this new
 * class, which is
