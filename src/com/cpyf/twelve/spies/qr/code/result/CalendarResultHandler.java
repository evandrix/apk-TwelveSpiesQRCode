    ...
    public void handleButtonPress(int index)
    {
        ...
        if (index == 0) {
            addCalendarEvent(calendarResult.getSummary(),
                ...
                calendarResult.getLocation(), calendarResult.getDescription());
        }
    }
    ...
    private static void appendTime(String when, StringBuffer result)
    {
        if (when.length() == 8) {
            ...
            ParsedResult.maybeAppend(
                DateFormat.getDateInstance().format(date.getTime()), result);
        } else {
            ...
            ParsedResult.maybeAppend(
                DateFormat.getDateTimeInstance().format(milliseconds), result);
        }
    }
