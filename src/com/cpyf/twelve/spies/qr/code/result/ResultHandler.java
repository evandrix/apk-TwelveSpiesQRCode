...
package com.cpyf.twelve.spies.qr.code.result;
...
import com.cpyf.twelve.spies.qr.code.book.*;
import com.cpyf.twelve.spies.qr.code.wifi.*;
...
public abstract class ResultHandler
{
     ...
     * Event UI. Older
     * versions of the system have a bug where the event title will not be
     * filled out.
     * 
     * @param summary A description of the event
     * @param start The start time as yyyyMMdd or yyyyMMdd'T'HHmmss or
     *            yyyyMMdd'T'HHmmss'Z'
     * @param end The end time as yyyyMMdd or yyyyMMdd'T'HHmmss or
     *            yyyyMMdd'T'HHmmss'Z'
    ...
    final void getDirections(double latitude, double longitude)
    {
        launchIntent(new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google."
                                        + LocaleManager.getCountryTLD()
                                        + "/maps?f=d&daddr=" + latitude + ','
                                        + longitude)));
    }
    ...
    protected void showNotOurResults(
        int index,
        AlertDialog.OnClickListener proceedListener)
    {
        ...
        if (prefs.getBoolean(PreferencesActivity.KEY_NOT_OUR_RESULTS_SHOWN,
            ...
            prefs.edit()
                            .putBoolean(
                                PreferencesActivity.KEY_NOT_OUR_RESULTS_SHOWN,
                                true).commit();
            AlertDialog.Builder builder = new AlertDialog.Builder(activity);
