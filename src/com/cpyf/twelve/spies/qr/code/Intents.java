...
package com.cpyf.twelve.spies.qr.code;
...
public final class Intents
{
    ...
    public static final class Scan
    {
         ...
         * the results.
         */
        public static final String ACTION = "com.cpyf.twelve.spies.qr.code.SCAN";

        /**
         * By default, sending Scan.ACTION will decode all barcodes that we
         * understand. However it
         * may be useful to limit scanning to certain formats. Use
         * Intent.putExtra(MODE, value) with
         ...
         * onActivityResult() of the app which
         * requested the scan via startSubActivity(). The barcodes contents can
         * be retrieved with
    ...
    public static final class Encode
    {
         ...
         */
        public static final String ACTION = "com.cpyf.twelve.spies.qr.code.ENCODE";

        /**
         * The data to encode. Use Intent.putExtra(DATA, data) where data is
         * either a String or a
         * Bundle, depending on the type and format specified. Non-QR Code
         * formats should
    ...
    public static final class SearchBookContents
    {
         ...
         */
        public static final String ACTION = "com.cpyf.twelve.spies.qr.code.SEARCH_BOOK_CONTENTS";
    ...
    public static final class WifiConnect
    {
         ...
         */
        public static final String ACTION = "com.cpyf.twelve.spies.qr.code.WIFI_CONNECT";
    ...
    public static final class Share
    {
         ...
         */
        public static final String ACTION = "com.cpyf.twelve.spies.qr.code.SHARE";
